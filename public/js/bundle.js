...
},{}],"../../../.nvm/versions/node/v22.2.0/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../../../.nvm/versions/node/v22.2.0/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"../../../.nvm/versions/node/v22.2.0/lib/node_modules/parcel-bundler/node_modules/isarray/index.js":[function(require,module,exports) {
var toString = {}.toString;
...
},{}],"../../../.nvm/versions/node/v22.2.0/lib/node_modules/parcel-bundler/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"../../../.nvm/versions/node/v22.2.0/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js","ieee754":"../../../.nvm/versions/node/v22.2.0/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js","isarray":"../../../.nvm/versions/node/v22.2.0/lib/node_modules/parcel-bundler/node_modules/isarray/index.js","buffer":"../../../.nvm/versions/node/v22.2.0/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../../node_modules/axios/lib/helpers/toFormData.js":[function(require,module,exports) {
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // const login = async (email, password) => {
//   try {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: 'http://localhost:3000/api/v1/users/loggout'
          });
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
...
function leaflet(locationMap) {
  //const locationMap = JSON.parse(document.querySelector('#map').dataset.locations);

  var _locationMap$0$coordi = _slicedToArray(locationMap[0].coordinates, 2),
    longitude = _locationMap$0$coordi[0],
    latitude = _locationMap$0$coordi[1];
...
var updateUserData = exports.updateUserData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userData) {
    var dt, form, response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          dt = _objectSpread({}, userData);
          _context.prev = 1;
          form = new FormData();
          ...
          _context.next = 8;
          return fetch('http://localhost:3000/api/v1/users/updateMe', {
            method: 'PATCH',
            /*  headers: {
              'Content-Type': 'application/json',
            }, */
        ...
        case 11:
          ...
          if (data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your data was successfully updated!');
          } else {
        ...
        case 17:
          ...
          (0, _alerts.showAlert)('error', 'It was not possible update the data. Try agan later!');
...
var updateUserPassword = exports.updateUserPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(passwords) {
    var response, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return fetch('http://localhost:3000/api/v1/users/updateMyPassword', {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json'
            },
        ...
        case 6:
          ...
          console.log(data);
          if (data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your password was successfully updated!');
          } else {
            (0, _alerts.showAlert)('error', data.message);
          }
          _context2.next = 14;
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51PkQE2P5HwHVlu8LfRXGiVBf4sJEubSRx9CrJNcJC2CvrAlvncMfxDRfIYympfCKQro3iZejL6x4DEcVAVfJkdQ600BN5csYAC');
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
// DOM ELEMENTES
var leafletMap = document.querySelector('#map');
var Loginform = document.querySelector('.form--login');
var logoutButton = document.querySelector('.nav__el--logout');
var userFormData = document.querySelector('.form-user-data');
var userFormPassword = document.querySelector('.form-user-settings');
var bookBtn = document.querySelector('#book-tour');

// DELEGATION
if (leafletMap) {
  var locationMap = JSON.parse(leafletMap.dataset.locations);
  (0, _leaflet.leaflet)(locationMap);
}
if (Loginform) {
...
if (userFormData) {
  userFormData.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var btnSaveSettings, name, email, photo;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
...
if (userFormPassword) {
  userFormPassword.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 7;
            return (0, _updateSettings.updateUserPassword)({
...
},{}]},{},["../../../.nvm/versions/node/v22.2.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
